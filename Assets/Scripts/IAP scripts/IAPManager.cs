...
{
    public HomeSceneUi shopRuby;
    private List<ItemIAP> listItems = new List<ItemIAP>();
    [SerializeField] GameObject noDataBoard;

    const string PACK_1 = "com.brickinvader.pack1";
    const string PACK_2 = "com.brickinvader.pack2";
    const string PACK_3 = "com.brickinvader.pack3";
    const string PACK_4 = "com.brickinvader.pack4";
    const string PACK_5 = "com.brickinvader.pack5";
    const string PACK_6 = "com.brickinvader.pack6";
    const string PACK_7 = "com.brickinvader.pack7";
    const string PACK_8 = "com.brickinvader.pack8";
