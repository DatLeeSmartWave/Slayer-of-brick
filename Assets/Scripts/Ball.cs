...
public class Ball : MonoBehaviour {
    ...
    [SerializeField] private Sprite[] ballSkins;
    ...
    void ShowBallSkin() {
        int ballSkinId = PlayerPrefs.GetInt(StringManager.ballId);
        if (ballSkinId < ballSkins.Length && ballSkinId >= 0) {
            ballSkin.sprite = ballSkins[ballSkinId];
        }
    }
}
